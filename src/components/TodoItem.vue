<template>
	<div v-if="!editMode" class="todo-item">
		...
		<button @click.prevent="editMode = true" class="app-button is-warning">
			Edit
		</button>
		<button @click.prevent="deleteTodo" class="app-button is-danger">
			Delete
		</button>
	</div>
		...
		<form class="app-form">
			...
			<div class="form-control form-control-last">
				...
				<textarea
					...
					class="form-input"
				></textarea>
				<button @click="editTodo" class="app-button is-warning">Update</button>
				<button @click="editMode = false" class="app-button is-danger">
					Cancel
				</button>
			</div>
		</form>
